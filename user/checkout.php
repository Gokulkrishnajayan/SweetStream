                                            ...
                                            <form action="update_delivery_address.php" method="POST">
                                                ...
                                                <div class="button-group">
                                                    <button type="button" id="edit-btn"
                                                        class="styled-btn">Change</button>
                                                    <button type="submit" id="save-btn" class="styled-btn"
            ...
            ?>
                                    ...
                                    <div class="card-body">
                                        <form id="paymentForm" action="process_payment.php" method="POST">
                                            ...
                                            <div class="submit-buttons">
                                                ...
                                                <button type="submit" id="orderBtn" class="boxed-btn"
                            ...
                            <script>
                                ...
                                document.addEventListener("DOMContentLoaded", function () {
                                    ...
                                    // Ensure phpGrandTotal value exists and is valid
                                ...
                                document.getElementById('payBtn').addEventListener('click', function () {
                                    ...
                                    // Alert the correct total amount
